...
const UserLanding = () => {
  const [stats, setStats] = useState<Stats>({ upcoming: 0, completed: 0, total: 0 });
        ...
        <>
          <div className="space-y-6 min-h-screen">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-purple-100">Your safe space for healing and growth</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-purple-600">{stats.upcoming}</span>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-gray-600 font-medium">Completed Sessions</h3>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-pink-600">{stats.total}</span>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <a href="/user/appointment" className="text-purple-600 hover:text-purple-700 font-medium text-sm">
                  View All
                </a>
              </div>
                    ...
                    <div key={apt._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{apt.counselor.specialization}</p>
                          <p className="text-sm text-gray-500">{formatDate(apt.appointmentDate)} at {apt.appointmentTime}</p>
                        </div>
                      </div>
            ...
            {/* Quick Actions */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <a href="/user/therapy" className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all group">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Find a Counselor</h3>
                <p className="text-sm text-gray-600">Browse and book with verified counselors</p>
              </a>

              <a href="/user/resources" className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all group">
                ...
                <p className="text-sm text-gray-600">Access helpful materials and guides</p>
              </a>

              <a href="/user/community" className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all group">
                ...
                <p className="text-sm text-gray-600">Connect with others on their journey</p>
              </a>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
              ...
              <p className="text-sm text-gray-600">
                Taking the step to seek support is courageous. Remember, healing is a journey, and we're here to support you every step of the way.
              </p>
            </div>
          </div>
