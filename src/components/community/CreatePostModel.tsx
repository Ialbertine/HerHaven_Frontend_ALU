...
import { X, Tag, Eye, EyeOff, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
      ...
      {!isExpanded ? (
        <button
          ...
          className="w-full p-6 flex items-center justify-between hover:bg-gray-50 transition-all rounded-xl"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 flex items-center justify-center text-white font-semibold text-lg">
              {isGuest ? 'G' : localStorage.getItem('username')?.charAt(0).toUpperCase() || 'U'}
            </div>
            <p className="text-gray-500 text-left">Share your thoughts, experiences, or ask a question...</p>
          </div>
